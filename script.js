...
function openForm(index = null) {
     ...
     if (index !== null) {
          ...
          document.getElementById("points").value = m.points.join(", ");
...
function renderMatchHistory() {
     ...
     for (let game in gameGroups) {
      ...
      <tr>
        <th>Game</th><th>Date</th><th>Players</th><th>Winner</th>
        <th>Losers</th><th>Points</th><th>Won By</th><th>Notes</th><th>Edit</th>
      </tr>`;

          gameGroups[game].forEach((m, i) => {
